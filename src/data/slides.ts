...
export const slides: SlideData[] = [
    {
        ...
        content: [
            '上から見下ろすよくわからないゲームを忍野ペペにやらされ、その上ジャングルとかいう難しいロールで右も左もよくわからないままシナシナになってませんか？',
            '"ああ横ならなぁ..."とゲーマーとしての自信が無くなっていきますよね。そんな自分から自信とプライドを取り戻す。',
            '石井と一緒は嫌だ',
    ...
    },
    {
        id: 2,
        type: 'content',
        title: 'Motivation and Claim. 動機と主張',
        content: [
            'とはいえネガティブな部分だけでなくメリットもあります',
            '「今のLoLコミュニティが活発な内にいっちょかみして人気配信者と一絡みして視聴者を取り込みたい」',
            '「あわよくばRiotから仕事を貰いたい...」',
            '「アホなふりをして、アホな視聴者を楽して取り込みたい。（最高！）」',
            '「でもアイアン位は...」',
    ...
    },
    {
        ...
        content: [
            'ここが一番の問題のシーンです。この直後にミッドに寄って更に１分、合計２分無駄にしています。',
            '周回を終えてないのにアクションを起こしています。',
            '先と合わせ合計３分近く集金タイミングを逃し、ボリベアに有利を取り返されています。',
            '実際はこの後に相手の森に入って時間を無駄にしたりなどしていましたが、これについてはナイスチャレンジです。気にしないでください。'
        ]
    },
    {
        id: 6,
    ...
    },
    {
        ...
        title: '余談：対面と比較しない',
        content: [
            '今回は相手ジャングルのボリベアと比較しましたが、実際は相手”チーム”と自分を比較してみてください。',
