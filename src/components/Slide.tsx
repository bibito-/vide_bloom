        ...
        >
            {data.type === 'title' && (
                <div className="space-y-6 md:space-y-8">
                    <h1 ref={titleRef} className="text-4xl md:text-6xl lg:text-8xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-lol-gold to-lol-blue">
                        {data.title}
                    </h1>
                    {data.highlight && (
            ...
            {data.type === 'content' && (
                <div className="w-full text-left space-y-6 md:space-y-8">
                    <h2 ref={titleRef} className="text-3xl md:text-4xl lg:text-6xl font-bold text-lol-gold border-b border-gray-700 pb-2 md:pb-4">
                        {data.title}
                    </h2>
            ...
            {data.type === 'video' && (
                <div className="w-full flex flex-col items-center justify-center space-y-4 md:space-y-8 py-8">
                    <h2 ref={titleRef} className="text-2xl md:text-3xl lg:text-5xl font-bold text-white mb-1 md:mb-2">
                        {data.title}
                    </h2>
            ...
            {data.type === 'quote' && (
                <div className="w-full flex flex-col items-center justify-center space-y-8 md:space-y-12">
                    ...
                    <h2 ref={titleRef} className="text-2xl md:text-4xl lg:text-6xl font-bold text-white leading-tight">
                        {data.highlight}
                    </h2>
